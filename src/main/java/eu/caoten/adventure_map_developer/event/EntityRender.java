            ...
            server.getWorlds().forEach(serverWorld -> {
                serverWorld.iterateEntities().forEach(entity -> {
                    if (entity instanceof MarkerEntity) {
                        double x = MathHelper.lerp(context.tickDelta(), entity.lastRenderX, entity.getX()) - context.camera().getPos().getX();
                        double y = MathHelper.lerp(context.tickDelta(), entity.lastRenderY, entity.getY()) - context.camera().getPos().getY();
                        double z = MathHelper.lerp(context.tickDelta(), entity.lastRenderZ, entity.getZ()) - context.camera().getPos().getZ();
